//
//  ARVirtualCamExtensionColorProvider.swift
...
class ARVirtualCamExtensionColorDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: ARVirtualCamExtensionColorStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = ARVirtualCamExtensionColorStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class ARVirtualCamExtensionColorStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? ARVirtualCamExtensionColorDeviceSource else {
...
class ARVirtualCamExtensionColorProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: ARVirtualCamExtensionColorDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = ARVirtualCamExtensionColorDeviceSource(localizedName: "SampleCapture (Swift)")
